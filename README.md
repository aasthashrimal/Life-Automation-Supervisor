...
Calendar Agent: Analyzes schedules and identifies free time

Meal Planner Agent: Creates nutrition-aware weekly meal plans

Grocery Agent: Generates optimized shopping lists

Travel Planner Agent: Compares transport options for efficiency

Finance Tracker Agent: Categorizes expenses and summarizes finances

Wellness Agent: Tracks habits and reminders

Memory Agent: Stores preferences and historical patterns for personalization
